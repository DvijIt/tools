...
import { getTasksList, updateTaskData } from './taskGateway.js';
...
export const changeStatus = e => {
  ...
  updateTaskData(taskId, updatedTask).then(() => getTasksList()).then(newTasksList => {
    setItem('tasksList', newTasksList);
    renderListItems();
  });
};
listItem.addEventListener("click", changeStatus); // 1. Prepare data
// 2. Update data in db
